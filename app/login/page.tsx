  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      toast({
        ...
        description: 'Ocurrió un error durante el proceso. Por favor, intenta de nuevo.',
        variant: 'destructive',
      });
    }
  };
      ...
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          <div className="flex items-center justify-center space-x-2 mb-4">
            ...
            <span className="text-3xl font-bold text-blue-600" style={{ fontFamily: 'Montserrat, sans-serif' }}>factura.hn</span>
          </div>
        ...
        <CardFooter>
          <div className="text-sm text-center w-full">
            ...
            <button onClick={toggleForm} className="ml-1 text-blue-600 hover:underline focus:outline-none">
